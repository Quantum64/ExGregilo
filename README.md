...
## Modpacks
In accordance with the GPLv3 license, you can use this code for pretty much whatever. That means you have full permission to include this mod in an unmodified or modified form in your modpacks. Just remember that any distributed modified version (or any mod that uses any code from this mod) are required to be open source to comply with the GPLv3 license.
